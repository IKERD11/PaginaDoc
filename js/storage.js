...
function actualizarDocumento(id, datosActualizados) {
    const documentos = JSON.parse(localStorage.getItem('documentos')) || [];
...
function obtenerEstadisticas() {
    ...
    const alumnosCompletos = alumnos.filter(a => {
        const estado = obtenerEstadoDocumentacion(a.numeroControl);
    ...
    return {
        ...
        alumnosCompletos,
        alumnosIncompletos: alumnos.length - alumnosCompletos,
